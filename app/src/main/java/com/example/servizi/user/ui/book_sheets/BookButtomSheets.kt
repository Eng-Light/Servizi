...
import com.example.servizi.databinding.BookButtomSheetsFragmentBinding
...
class BookButtomSheets :BottomSheetDialogFragment() {
    ...
    val binding:BookButtomSheetsFragmentBinding by lazy {
        BookButtomSheetsFragmentBinding.inflate(layoutInflater)
    }
    private lateinit var viewModel:BookButtomSheetsViewModel
    ...
    override fun onCreateView(
       ...
       // binding = getFragmentBinding(inflater, container)
        ...
        viewModel = ViewModelProvider(this, factory)[BookButtomSheetsViewModel::class.java]
